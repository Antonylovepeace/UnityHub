...
public class TypeWriter2 : MonoBehaviour
{
    ...
    private static TypeWriter2 instance;
    public List<TypeWriterMessage2> messages = new List<TypeWriterMessage2>();

    private TypeWriterMessage2 currentMsg = null;
    private int msgIndex = 0;

    public static void Add(string msg, Action callback = null)
    {
        TypeWriterMessage2 typeMsg = new TypeWriterMessage2(msg, callback);
...
public class TypeWriterMessage2
{
    ...
    public TypeWriterMessage2(string msg, Action callback = null)
    {
